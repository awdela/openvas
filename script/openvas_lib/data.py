...
class OpenVASPort(object):
    ...
    # ----------------------------------------------------------------------
    def __init__(self, number, proto):
        """
    ...
    def __str__(self):
        return "(%s/%s)" % (self.number, self.proto)
...
class OpenVASNVT(_Common):
    ...
    def __init__(self):
        ...
        self.__cves = []
        self.__raw_cves = None
        self.__bids = []
        self.__raw_bids = None
        self.__bugtraqs = []
        self.__raw_bugtraqs = None
        self.__xrefs = []
        self.__raw_xrefs =None
        self.__fingerprints = ""
        self.__tags = []
        self.__certs = "" 
    ...
    def description(self, val):
        """
        :param val: The description of result
        :type val: str
        """
        if not isinstance(val, str):
            raise TypeError("Expected string, got %r instead" % type(val))
    ...
    def raw_cves(self):
        ...
        :rtype: str
        """
        self.__raw_cves = ",".join(self.__cves)

        return self.__raw_cves

    # ----------------------------------------------------------------------
    @property
    def raw_bids(self):
        """
        :return:Bugtraq ID (software vulnerability tracking)
        :rtype: str
        """
        self.__raw_bids = ",".join(self.__bids)
        return self.__raw_bids 
    ...
    def raw_xrefs(self):
        ...
        :rtype: str
        """
        self.__raw_xrefs = ",".join(self.__xrefs)
        return self.__raw_xrefs
    ...
    def raw_tags(self, val):
        ...
        for x in _range(len(positions)):
            ...
            if range_text:
                ...
                # Remove start and end spaces, and remove last '|'
                text = text.strip().strip('|')

                setattr(self, "_OpenVASNVT__%s" % var_name, text)
...
class OpenVASResult(_Common):
    ...
    def creation_time(self):
        """
        :return: the create time of scan result
        :rtype: str
        """
    ...
    def modification_time(self):
        """
        :return: the modification time of scan result
        :rtype: str
        """
    ...
    def modification_time(self, val):
        """
        :type val: str
        """
        if not isinstance(val, str):
    ...
    # ----------------------------------------------------------------------
    @property
    def scan_nvt_version(self):
        """
        :rtype: str
        """
        return self.__scan_nvt_version

    # ----------------------------------------------------------------------
    @scan_nvt_version.setter
    def scan_nvt_version(self, val):
        """
        :type val: str
        """
        if not isinstance(val, str):
    ...
    def severity(self, val):
        ...
        if not isinstance(val, str):
            raise TypeError("Expected str, got %r instead" % type(val))
        """ si she wu ru"""
        int_val = int(round(float(val))/2)
        self.__severity = int_val
